...
public class CommandeController {
    ...
    @Value("${mock.api.url:http://192.168.68.63:3000/api/kubii/commande}")
    ...
    public ResponseEntity<?> getCommande(@PathVariable String id) {
        Optional<Commande> commande = couchDbService.getCommandeById(id);
